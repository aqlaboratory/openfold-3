...
from openfold3.base.data.feature_pipelines.feature_pipelines import (
    AF3BioAssemblyFeaturePipeline,
)
from openfold3.base.data.preprocessing.preprocessing_pipelines import (
...
class OpenFoldSingleDataset(ABC, Dataset):
    """Abstract SingleDataset class for implementing preprocessing and feature pipeline ATTRIBUTES. Requires register_dataset decorator."""
    ...
    def preprocessing_pipeline(self):
        ...
        Requires the definition of the following class method:
            @property
            def preprocessing_pipeline(self):
    ...
    def calculate_datapoint_probabilities(self) -> float:
        """Calculates list of datapoint probabilities.
        
        Datapoint probabilities should be parsed from the data_cache using the dataset-specific sampling formula 
        and be assigned to self.datapoint_probabilities."""
        pass
