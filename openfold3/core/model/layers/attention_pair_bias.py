...
class AttentionPairBias(nn.Module):
    ...
    Implements AF3 Algorithm 24 for the trunk.
    """
    ...
    def __init__(
        ...
        gating: bool = True,
        inf=1e9,
        linear_init_params: ConfigDict | None = lin_init.att_pair_bias_init,
    ):
        """
        Args:
            c_q:
...
class DiffusionAttentionPairBias(nn.Module):
    ...
    Implements AF3 Algorithm 24 for the trunk with adaptive layernorm.
    """
    ...
    def __init__(
        ...
        gating: bool = True,
        inf=1e9,
        linear_init_params: ConfigDict | None = lin_init.diffusion_att_pair_bias_init,
    ):
        """
        Args:
            c_q:
    ...
    def forward(
        ...
        Args:
            ...
            z:
                [*, N, N, C_z] Pair embedding
            s:
                [*, N, C_s] Single embedding. Used in AdaLN.
            mask:
                [*, N] Mask for token or atom-level embedding
            use_deepspeed_evo_attention:
                Whether to use DeepSpeed Evo Attention kernel
