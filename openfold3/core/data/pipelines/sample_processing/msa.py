...
from openfold3.core.data.io.sequence.msa import parse_mmseqs_a3m, parse_msas_sample
...
def process_msas_msaserver(
    ...
    ## setup mappings
    chainid2reprid = {
        v["chain_id"]: v["alignment_representative_id"] for v in assembly_data.values()
    }
    chainid2moltype = {
