...
def crop_contiguous(atom_array: AtomArray, token_budget: int, generator: Generator):
    ...
    for chain_id in chains:
        ...
        # Get chain length
        chain_length = atom_array_chain.af3_token_id[-1] - atom_array_chain.af3_token_id[0] + 1
        ...
        crop_size_min = np.min([chain_length, np.max([0, token_budget - tokens_added - tokens_remaining])])
