...
class OpenFoldSingleMultimerDataset(torch.utils.data.Dataset):
    def __init__(
        ...
        """
        This class check each individual PDB ID and return its chain(s)
...
def aa_count_filter(seqs: list, max_single_aa_ratio: float) -> bool:
    """Check if any single aa accounts for g.t. max_single_aa_ratio of sequence(s)"""
    counts = {}
    for seq in seqs:
        for aa in seq:
    ...
    return largest_single_aa_prop <= max_single_aa_ratio
...
class OpenFoldDataset(torch.utils.data.Dataset):
    ...
    def looped_samples(self, dataset_idx):
        ...
        while True:
            ...
            for datapoint_idx in cache:  # noqa: UP028
                yield datapoint_idx
...
class OpenFoldDataLoader(torch.utils.data.DataLoader):
    ...
    def _add_batch_properties(self, batch):
        ...
        resample_recycling = lambda t: t[..., : no_recycling + 1]  # noqa: E731
