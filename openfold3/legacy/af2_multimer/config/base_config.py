...
import openfold3.legacy.af2_monomer.config.base_config as af2_monomer_config  # noqa: E501
from openfold3.legacy.af2_multimer.config import (
    linear_init_config as lin_init_mult,
)
from openfold3.legacy.af2_multimer.config.features import (
