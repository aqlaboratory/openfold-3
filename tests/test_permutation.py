...
from openfold3.core.utils.multi_chain_permutation import (
...
class TestPermutation(unittest.TestCase):
    def setUp(self):
        ...
        self.asym_id = torch.tensor(
            [
                [1] * self.chain_a_num_res
                + [2] * self.chain_a_num_res
                + [3] * self.chain_b_num_res
                + [4] * self.chain_b_num_res
                + [5] * self.chain_b_num_res
            ],
            device=device,
        )
