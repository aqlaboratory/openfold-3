...
from openfold3.core.utils.diffusion_loss import (
    bond_loss,
    diffusion_loss,
    mse_loss,
    smooth_lddt_loss,
...
class TestDiffusionLoss(unittest.TestCase):
    ...
    def test_weighted_rigid_align(self):
        ...
        x_align = weighted_rigid_align(x=x,
                                       x_gt=x_gt,
                                       w=w,
                                       atom_mask=atom_mask)
    ...
    def test_diffusion_loss(self):
        ...
        loss = diffusion_loss(batch=batch,
                              x=x,
                              x_gt=x_gt,
                              atom_mask=atom_mask,
                              t=t,
