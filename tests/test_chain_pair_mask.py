import torch
from openfold3.core.data.framework.single_datasets.validation import make_chain_pair_mask_padded
...
def test_chain_pair_mask_padded():
    ...
    actual_chain_pair_mask = make_chain_pair_mask_padded(chain_id, interfaces_to_include)
